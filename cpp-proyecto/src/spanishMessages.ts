...
export const spanishMessages: TranslationMessages = {
    ra: {
        ...
        input: {
            file: {
                upload_several:
                    'Suelta algunos archivos para cargar, o haz clic para seleccionar uno.',
                upload_single: 'Suelta un archivo para cargar, o haz clic para seleccionarlo.',
            },
            image: {
                upload_several:
                    'Suelta algunas imágenes para cargar, o haz clic para seleccionar una.',
                upload_single:
                    'Suelta una imagen para cargar, o haz clic para seleccionarla.',
            },
            references: {
                all_missing: 'No se pudo encontrar los datos de referencia.',
                many_missing:
        ...
        message: {
            ...
            no: 'No',
            not_found:
                'O escribiste una URL incorrecta, o seguiste un enlace malo.',
