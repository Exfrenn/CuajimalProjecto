...
var useLogoutIfAccessDenied = function () {
    ...
    var logoutIfAccessDenied = (0, react_1.useCallback)(function (error) { return __awaiter(void 0, void 0, void 0, function () {
        var e_1, logoutUser, redirectTo, shouldNotify, _a;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 8]);
                    return [4 /*yield*/, authProvider.checkError(error)];
                case 2:
                    _c.sent();
                    return [2 /*return*/, false];
                case 3:
                    e_1 = _c.sent();
                    logoutUser = (_b = e_1 === null || e_1 === void 0 ? void 0 : e_1.logoutUser) !== null && _b !== void 0 ? _b : true;
                    // manual debounce
                    if (timer) {
                    ...
                    redirectTo = e_1 && e_1.redirectTo != null
                        ? e_1.redirectTo
                        : error && error.redirectTo
                            ? error.redirectTo
                            : undefined;
                    shouldNotify = !((e_1 && e_1.message === false) ||
                ...
                case 5:
                    ...
                    _c.sent();
                    if (logoutUser) {
                        notify(getErrorMessage(e_1, 'ra.notification.logged_out'), { type: 'error' });
                    }
                    else {
                        notify(getErrorMessage(e_1, 'ra.notification.not_authorized'), { type: 'error' });
                    }
                    return [3 /*break*/, 7];
                case 6:
                    _a = _c.sent();
